...
class GreedyBustersAgent(BustersAgent):
    ...
    def chooseAction(self, gameState):
        ...
        bestGhostPos = None
        minDis = float('inf')
        for ghostPos in distributionMax:
        	curDis = self.distancer.getDistance(pacmanPosition, ghostPos)
        	if curDis < minDis:
        		minDis = curDis
        ...
        for action in legal:
            ...
            successorDist = self.distancer.getDistance(successorPos, bestGhostPos)
            if bestDist > successorDist:
